...
public class DesktopFile {
	 ...
	 *            {@code Directory} (type 3).
	 * @param name
	 *            Specific name of the application, for example {@code Mozilla}.
	 */
	 ...
	 *            {@code Web Browser}.
	 * @param noDisplay
	 *            {@code noDisplay} means <i>"this application exists, but don't
	 ...
	 *            including e.g. the {@code netscape}
	 * @param comment
	 *            Tooltip for the entry, for example <i>"View sites on the
	 ...
	 *            Theme Specification</a> will be used to locate the icon.
	 * @param hidden
	 *            {@code hidden} should have been called {@code deleted}. It
	 ...
	 *            by letting {@code make install} install a file with
	 *            {@code Hidden=true} in it.
	 * @param dBusActivatable
	 *            A boolean value specifying if D-Bus activation is supported
	 ...
	 *            for example).
	 * @param exec
	 *            Program to execute, possibly with arguments. See the <a href=
	 ...
	 *            {@code DBusActivatable}.
	 * @param path
	 *            If entry is of type {@code Application}, the working directory
	 ...
	 *            "http://www.freedesktop.org/Standards/menu-spec">Desktop Menu
	 *            Specification</a>).
	 * @param implementsEntry
	 *            A list of interfaces that this application implements. By
	 ...
	 *            {@code Name} or {@code GenericName}.
	 * @param startupNotify
	 *            If {@code true}, it is <b><i>KNOWN</i></b> that the
	 ...
	 *            "http://www.freedesktop.org/Standards/startup-notification-spec">Startup
	 *            Notification Protocol Specification</a> for more details).
	 * @param startupWMClass
	 *            If specified, it is known that the application will map at
