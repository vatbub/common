...
/**
 * Implement this interface to replace the behaviour that the {@link PlatformIndependentMOTD} class uses to save read messages.
 */
public interface MOTDFileOutputStreamProvider {
     ...
     * <ul>
     *     <li>Folders where the application has write access for (good idea: Use {@code Common.getAppDataPath()} from the core module)</li>
     ...
     * @param fileName The name of the file to create a {@code FileOutputStream} for. The supplied file name must not be changed or otherwise the {@link PlatformIndependentMOTD} class will not work properly.
